...
function hexToRgb (hexValue, opc) {
    ...
    console.log(hexValue, opc, rgb, 'rgbbbb')
    if (rgb) {
    ...
    if (opts.xAxis.disabled !== true) {
        ...
        if (config._xAxisTextAngle_ === 0) {
            ...
            newCategories.forEach(function (item, index) {
                ...
                const offsetY = startY + 6 * opts.pix + xAxisFontSize - xAxisFontSize * Math.abs(Math.sin(config._xAxisTextAngle_))
...
function drawCharts (type, opts, config, context) {
    ...
    } else if (opts.type === 'line' || opts.type === 'area' || opts.type === 'scatter' || opts.type === 'bubble' || opts.type === 'bar') {
...
uCharts.prototype.updateData = function () {
    ...
    switch (scrollPosition) {
        ...
        case 'left':
            ...
            break
        case 'right':
            const _calYAxisData = calYAxisData(this.opts.series, this.opts, this.config, this.context), yAxisWidth = _calYAxisData.yAxisWidth
            this.config.yAxisWidth = yAxisWidth
            let offsetLeft = 0
            const _getXAxisPoints0 = getXAxisPoints(this.opts.categories, this.opts, this.config), xAxisPoints = _getXAxisPoints0.xAxisPoints,
